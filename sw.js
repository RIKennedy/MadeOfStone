...
self.__precacheManifest = [
  {
    "url": "webpack-runtime-b55dee7051390d300720.js"
  },
  {
    "url": "framework-17193c917176a9ab3be2.js"
  },
  {
    "url": "app-168b7ee5e69491854dce.js"
  },
  {
    "url": "offline-plugin-app-shell-fallback/index.html",
    "revision": "b6b26835fc7c12ad292e1680283d6ab2"
  },
  {
  ...
  },
  {
    ...
    "revision": "dfbffdf6f2e993b6b6b33ae3acd16f69"
  },
  {
  ...
  },
  {
    ...
    "revision": "7aade088ac64e70df73d01772807e7fc"
  }
...
const navigationRoute = new NavigationRoute(async ({ event }) => {
  ...
  pathname = pathname.replace(new RegExp(`^/MadeOfStone`), ``)

  // Check for resources + the app bundle
  // The latter may not exist if the SW is updating to a new version
  const resources = await idbKeyval.get(`resources:${pathname}`)
  if (!resources || !(await caches.match(`/MadeOfStone/app-168b7ee5e69491854dce.js`))) {
    return await fetch(event.request)
  }
  ...
  const offlineShell = `/MadeOfStone/offline-plugin-app-shell-fallback/index.html`
